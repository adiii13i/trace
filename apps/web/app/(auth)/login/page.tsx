  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-xs">
        ...
        <a href={`https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}&redirect_uri=${typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000'}/auth/google&response_type=code&scope=openid%20email%20profile&prompt=select_account`}
          className="flex items-center gap-2.5 w-full px-3 py-2.5 border border-zinc-700 bg-zinc-900 text-zinc-200 text-xs hover:bg-zinc-800 hover:border-zinc-600 transition-colors mb-5">
